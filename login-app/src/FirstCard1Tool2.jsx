        ...
        <div className="card-group">
          ...
          <div className="card" style={styles.card1}>
            <div className="card-header">
              <Lottie loop animationData={Python} play style={{ height: "50px" }} />
            </div>
            <div className="card-body">
              <button className="card-title" style={{ fontSize: "15px", textAlign: "center", backgroundColor: "white" }} onClick={() => navigate("/firstCard1")}>
                <b>Code Explainer</b>
            ...
            <div className="card-footer">
              <button type="button" className="btn btn-primary btn-sm" style={styles.button} onClick={() => navigate("/first")}
                onMouseOver={(e) => {
...
export default FirstCard1Tool2;
